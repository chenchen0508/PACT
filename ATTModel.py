...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.totalAttention = MultiHeadedAttention(26,config.head_num,config.dropout)
    ...
    def forward(self, batch_sent):
        ...
        return score, loss, label, weight#torch.cat([weight_w,weight_p,weight_s,weight_d],dim=1)
